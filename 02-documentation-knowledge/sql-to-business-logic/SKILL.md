...
description: Translate SQL queries into plain business language. Use when explaining complex queries to non-technical stakeholders, documenting query logic, or creating business glossaries from technical implementations.
---
...
This skill helps you translate sql queries into plain business language.

## Context Requirements

Before proceeding, I need:

1. **SQL Query**: Key information needed for this analysis
2. **Business term mappings**: Key information needed for this analysis
3. **Domain-specific terms**: Key information needed for this analysis
4. **Audience technical level**: Key information needed for this analysis
...
### For SQL Query:
"To proceed with sql to business logic, I need to understand sql query.

Please provide:
- [Specific detail 1 about sql query]
- [Specific detail 2 about sql query]
- [Optional context that would help]"


### For Business term mappings:
"To proceed with sql to business logic, I need to understand business term mappings.

Please provide:
- [Specific detail 1 about business term mappings]
- [Specific detail 2 about business term mappings]
- [Optional context that would help]"


### For Domain-specific terms:
"To proceed with sql to business logic, I need to understand domain-specific terms.

Please provide:
- [Specific detail 1 about domain-specific terms]
- [Specific detail 2 about domain-specific terms]
- [Optional context that would help]"
...
Following best practices for sql to business logic, I'll:
...
```
Sql To Business Logic Analysis
Generated: [timestamp]
...
**Scenario: User requests sql to business logic without providing context**
→ Response: "I can help with sql to business logic! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
