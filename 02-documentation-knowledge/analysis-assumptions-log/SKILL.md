...
description: Systematic tracking of analysis assumptions and decisions. Use when documenting data filtering choices, handling edge cases, making assumptions about missing data, or logging methodology decisions.
---
...
This skill helps you systematic tracking of analysis assumptions and decisions.

## Context Requirements

Before proceeding, I need:

1. **Assumption categories**: Key information needed for this analysis
2. **Documentation location**: Key information needed for this analysis
...
### For Assumption categories:
"To proceed with analysis assumptions log, I need to understand assumption categories.

Please provide:
- [Specific detail 1 about assumption categories]
- [Specific detail 2 about assumption categories]
- [Optional context that would help]"


### For Documentation location:
"To proceed with analysis assumptions log, I need to understand documentation location.

Please provide:
- [Specific detail 1 about documentation location]
- [Specific detail 2 about documentation location]
- [Optional context that would help]"


### For Review process:
"To proceed with analysis assumptions log, I need to understand review process.
...
Following best practices for analysis assumptions log, I'll:
...
```
Analysis Assumptions Log Analysis
Generated: [timestamp]
...
**Scenario: User requests analysis assumptions log without providing context**
→ Response: "I can help with analysis assumptions log! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
