...
description: Standardized metadata creation for data assets. Use when cataloging new datasets, documenting data sources, defining data ownership, or creating searchable data documentation.
---
...
This skill helps you standardized metadata creation for data assets.

## Context Requirements

Before proceeding, I need:

1. **Catalog tool schema**: Key information needed for this analysis
2. **Required metadata fields**: Key information needed for this analysis
3. **Data classification levels**: Key information needed for this analysis
4. **Tagging taxonomy**: Key information needed for this analysis

## Context Gathering

If any required context is missing from our conversation, I'll ask for it using these prompts:

### For Catalog tool schema:
"To proceed with data catalog entry, I need to understand catalog tool schema.

Please provide:
- [Specific detail 1 about catalog tool schema]
- [Specific detail 2 about catalog tool schema]
- [Optional context that would help]"


### For Required metadata fields:
"To proceed with data catalog entry, I need to understand required metadata fields.

Please provide:
- [Specific detail 1 about required metadata fields]
- [Specific detail 2 about required metadata fields]
- [Optional context that would help]"


### For Data classification levels:
"To proceed with data catalog entry, I need to understand data classification levels.

Please provide:
- [Specific detail 1 about data classification levels]
- [Specific detail 2 about data classification levels]
- [Optional context that would help]"
...
Following best practices for data catalog entry, I'll:
...
**Scenario: User requests data catalog entry without providing context**
→ Response: "I can help with data catalog entry! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
