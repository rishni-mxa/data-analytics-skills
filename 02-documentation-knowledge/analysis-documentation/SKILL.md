...
description: Structured analysis documentation with reproducible findings. Use when documenting analysis methodology, creating analysis handoff documents, or building knowledge bases for recurring analyses.
---
...
This skill helps you structured analysis documentation with reproducible findings.

## Context Requirements

Before proceeding, I need:

1. **Documentation template**: Key information needed for this analysis
2. **Required sections**: Key information needed for this analysis
3. **Audience definitions**: Key information needed for this analysis
4. **Storage location**: Key information needed for this analysis
...
"To proceed with analysis documentation, I need to understand documentation template.

Please provide:
- [Specific detail 1 about documentation template]
- [Specific detail 2 about documentation template]
- [Optional context that would help]"


### For Required sections:
"To proceed with analysis documentation, I need to understand required sections.

Please provide:
- [Specific detail 1 about required sections]
- [Specific detail 2 about required sections]
- [Optional context that would help]"


### For Audience definitions:
"To proceed with analysis documentation, I need to understand audience definitions.

Please provide:
- [Specific detail 1 about audience definitions]
- [Specific detail 2 about audience definitions]
- [Optional context that would help]"
...
Following best practices for analysis documentation, I'll:
...
**Scenario: User requests analysis documentation without providing context**
→ Response: "I can help with analysis documentation! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
