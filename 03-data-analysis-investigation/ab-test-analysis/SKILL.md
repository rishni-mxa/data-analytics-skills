...
This skill helps you rigorous a/b test statistical analysis.

## Context Requirements

Before proceeding, I need:

1. **Experimentation platform**: Key information needed for this analysis
2. **Standard test parameters**: Key information needed for this analysis
3. **Randomization unit**: Key information needed for this analysis
4. **Primary vs secondary metrics**: Key information needed for this analysis
5. **Guardrail metrics**: Key information needed for this analysis

## Context Gathering

If any required context is missing from our conversation, I'll ask for it using these prompts:

### For Experimentation platform:
"To proceed with ab test analysis, I need to understand experimentation platform.

Please provide:
- [Specific detail 1 about experimentation platform]
- [Specific detail 2 about experimentation platform]
- [Optional context that would help]"


### For Standard test parameters:
"To proceed with ab test analysis, I need to understand standard test parameters.

Please provide:
- [Specific detail 1 about standard test parameters]
- [Specific detail 2 about standard test parameters]
- [Optional context that would help]"


### For Randomization unit:
"To proceed with ab test analysis, I need to understand randomization unit.

Please provide:
- [Specific detail 1 about randomization unit]
- [Specific detail 2 about randomization unit]
- [Optional context that would help]"
...
Following best practices for ab test analysis, I'll:
...
**Scenario: User requests ab test analysis without providing context**
→ Response: "I can help with ab test analysis! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
