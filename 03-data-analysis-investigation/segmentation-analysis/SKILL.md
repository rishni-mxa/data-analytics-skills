...
This skill helps you customer/user segmentation with actionable insights.

## Context Requirements

Before proceeding, I need:

1. **Existing segments**: Key information needed for this analysis
2. **Key segmentation variables**: Key information needed for this analysis
3. **Minimum segment size**: Key information needed for this analysis
4. **Business goals per segment**: Key information needed for this analysis
...
"To proceed with segmentation analysis, I need to understand existing segments.

Please provide:
- [Specific detail 1 about existing segments]
- [Specific detail 2 about existing segments]
- [Optional context that would help]"


### For Key segmentation variables:
"To proceed with segmentation analysis, I need to understand key segmentation variables.

Please provide:
- [Specific detail 1 about key segmentation variables]
- [Specific detail 2 about key segmentation variables]
- [Optional context that would help]"


### For Minimum segment size:
"To proceed with segmentation analysis, I need to understand minimum segment size.

Please provide:
- [Specific detail 1 about minimum segment size]
- [Specific detail 2 about minimum segment size]
- [Optional context that would help]"
...
Following best practices for segmentation analysis, I'll:
...
**Scenario: User requests segmentation analysis without providing context**
→ Response: "I can help with segmentation analysis! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
