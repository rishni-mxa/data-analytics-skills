...
This skill helps you standard business metric calculation with industry benchmarks.

## Context Requirements

Before proceeding, I need:

1. **Company metric definitions**: Key information needed for this analysis
2. **Numerator/denominator rules**: Key information needed for this analysis
3. **Calculation frequency**: Key information needed for this analysis
4. **Data sources per metric**: Key information needed for this analysis

## Context Gathering

If any required context is missing from our conversation, I'll ask for it using these prompts:

### For Company metric definitions:
"To proceed with business metrics calculator, I need to understand company metric definitions.

Please provide:
- [Specific detail 1 about company metric definitions]
- [Specific detail 2 about company metric definitions]
- [Optional context that would help]"


### For Numerator/denominator rules:
"To proceed with business metrics calculator, I need to understand numerator/denominator rules.

Please provide:
- [Specific detail 1 about numerator/denominator rules]
- [Specific detail 2 about numerator/denominator rules]
- [Optional context that would help]"


### For Calculation frequency:
"To proceed with business metrics calculator, I need to understand calculation frequency.

Please provide:
- [Specific detail 1 about calculation frequency]
- [Specific detail 2 about calculation frequency]
- [Optional context that would help]"
...
Following best practices for business metrics calculator, I'll:
...
```
Business Metrics Calculator Analysis
Generated: [timestamp]
...
**Scenario: User requests business metrics calculator without providing context**
→ Response: "I can help with business metrics calculator! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
