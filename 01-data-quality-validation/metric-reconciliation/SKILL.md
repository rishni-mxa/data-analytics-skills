...
This skill helps you cross-source metric validation and discrepancy investigation.

## Context Requirements

Before proceeding, I need:

1. **Source system differences**: Key information needed for this analysis
2. **Acceptable variance ranges**: Key information needed for this analysis
3. **Metric calculation differences**: Key information needed for this analysis
4. **Known reconciliation issues**: Key information needed for this analysis

## Context Gathering

If any required context is missing from our conversation, I'll ask for it using these prompts:

### For Source system differences:
"To proceed with metric reconciliation, I need to understand source system differences.

Please provide:
- [Specific detail 1 about source system differences]
- [Specific detail 2 about source system differences]
- [Optional context that would help]"


### For Acceptable variance ranges:
"To proceed with metric reconciliation, I need to understand acceptable variance ranges.

Please provide:
- [Specific detail 1 about acceptable variance ranges]
- [Specific detail 2 about acceptable variance ranges]
- [Optional context that would help]"


### For Metric calculation differences:
"To proceed with metric reconciliation, I need to understand metric calculation differences.

Please provide:
- [Specific detail 1 about metric calculation differences]
- [Specific detail 2 about metric calculation differences]
- [Optional context that would help]"
...
Following best practices for metric reconciliation, I'll:
...
**Scenario: User requests metric reconciliation without providing context**
→ Response: "I can help with metric reconciliation! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
