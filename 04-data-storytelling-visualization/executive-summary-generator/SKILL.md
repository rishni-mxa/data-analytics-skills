...
description: Concise executive-level analysis summaries. Use when creating board presentations, executive briefings, or high-level metric dashboards focusing on 'so what' and actionable takeaways.
---
...
This skill helps you concise executive-level analysis summaries.
...
2. **Executive deck template**: Key information needed for this analysis
3. **Key metrics for leadership**: Key information needed for this analysis
4. **Presentation style**: Key information needed for this analysis
5. **Length limits**: Key information needed for this analysis
...
"To proceed with executive summary generator, I need to understand analysis findings.
...
### For Executive deck template:
"To proceed with executive summary generator, I need to understand executive deck template.

Please provide:
- [Specific detail 1 about executive deck template]
- [Specific detail 2 about executive deck template]
- [Optional context that would help]"


### For Key metrics for leadership:
"To proceed with executive summary generator, I need to understand key metrics for leadership.

Please provide:
- [Specific detail 1 about key metrics for leadership]
- [Specific detail 2 about key metrics for leadership]
- [Optional context that would help]"
...
Following best practices for executive summary generator, I'll:
...
```
Executive Summary Generator Analysis
Generated: [timestamp]
...
**Scenario: User requests executive summary generator without providing context**
→ Response: "I can help with executive summary generator! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
