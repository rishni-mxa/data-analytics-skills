...
description: Comprehensive dashboard requirements documentation. Use when designing new dashboards, specifying dashboard logic for engineers, or documenting dashboard maintenance requirements.
---
...
This skill helps you comprehensive dashboard requirements documentation.

## Context Requirements

Before proceeding, I need:

1. **Dashboard purpose**: Key information needed for this analysis
2. **Spec template**: Key information needed for this analysis
3. **BI tool specifics**: Key information needed for this analysis
4. **Performance requirements**: Key information needed for this analysis
5. **Access control**: Key information needed for this analysis
...
"To proceed with dashboard specification, I need to understand dashboard purpose.

Please provide:
- [Specific detail 1 about dashboard purpose]
- [Specific detail 2 about dashboard purpose]
- [Optional context that would help]"


### For Spec template:
"To proceed with dashboard specification, I need to understand spec template.

Please provide:
- [Specific detail 1 about spec template]
- [Specific detail 2 about spec template]
- [Optional context that would help]"


### For BI tool specifics:
"To proceed with dashboard specification, I need to understand bi tool specifics.

Please provide:
- [Specific detail 1 about bi tool specifics]
- [Specific detail 2 about bi tool specifics]
- [Optional context that would help]"
...
Following best practices for dashboard specification, I'll:
...
**Scenario: User requests dashboard specification without providing context**
→ Response: "I can help with dashboard specification! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
