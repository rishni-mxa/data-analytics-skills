...
description: Structure analytical findings into compelling narratives. Use when creating analysis presentations, building data stories for stakeholders, or framing insights with business context and recommendations.
---
...
This skill helps you structure analytical findings into compelling narratives.
...
2. **Presentation template**: Key information needed for this analysis
3. **Audience profiles**: Key information needed for this analysis
4. **Story length**: Key information needed for this analysis
5. **Required elements**: Key information needed for this analysis
...
"To proceed with data narrative builder, I need to understand analysis findings.
...
"To proceed with data narrative builder, I need to understand presentation template.

Please provide:
- [Specific detail 1 about presentation template]
- [Specific detail 2 about presentation template]
- [Optional context that would help]"


### For Audience profiles:
"To proceed with data narrative builder, I need to understand audience profiles.

Please provide:
- [Specific detail 1 about audience profiles]
- [Specific detail 2 about audience profiles]
- [Optional context that would help]"
...
Following best practices for data narrative builder, I'll:
...
```
Data Narrative Builder Analysis
Generated: [timestamp]
...
**Scenario: User requests data narrative builder without providing context**
→ Response: "I can help with data narrative builder! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
